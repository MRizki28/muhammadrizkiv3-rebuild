...
const Hero = () => {
    ...
    const [skills, setSkills] = useState(initialSkills.slice(0, 3));

    const toggleSkills = () => {
        setShowAllSkills(!showAllSkills);
        setSkills(showAllSkills ? initialSkills.slice(0, 3) : initialSkills);
    };
    return (
        <>
                            ...
                            <ul className="flex flex-row flex-wrap ml-0">
                                {skills.map((skill, index) => (
                                    <li key={index} className="flex  items-center justify-center last:mr-0 mr-2 mb-2">
                                        <span className="inline-block bg-gray-200 rounded-sm px-2 py-1 text-xs font-normal last:mr-0">{skill}</span>
                                    </li>
                                ))}
                                <button onClick={toggleSkills} className="inline-block bg-gray-200 rounded-sm px-2 py-1 text-xs font-normal last:mr-0">
                                    {showAllSkills ? "-" : "+"}
                                </button>
                            </ul>
                        </div>
                        <div >
                            <ul className="flex flex-row ml-0  justify-start">
                                <li className="flex flex-row items-center  mr-4 mb-2">
                                    <a href="https://linkedin.com/in/mrizki28" className="transition duration-200 ease-in-out flex flex-row items-center text-black hover:text-red-600" title="Muhammad Rizki Linkedin" target="_blank" rel="noopener noreferrer">
                                ...
                                <li className="flex flex-row items-center  mr-4 mb-2">
                                    <a href="https://www.github.com/MRizki28/" className="transition duration-200 ease-in-out flex flex-row items-center text-black hover:text-red-600" title="Muhammad Rizki github" target="_blank" rel="noopener noreferrer">
                                ...
                                <li className="flex flex-row items-center  mr-4 mb-2">
                                    <a href="https://instagram.com/m_rizkii28" className="transition duration-200 ease-in-out flex flex-row items-center text-black hover:text-red-600" title="Muhammad Rizki github" target="_blank" rel="noopener noreferrer" >
            ...
            <div>
                <p className="font-light max-w-screen-xl">Hey there! I'm Muhammad Rizki. I work as a full-time software developer. In my free time I do open source. Most of my open source
                    project
