        ...
        <>
            <div className="flex flex-col items-center sm:flex-row mb-12">
                <div className="mr-0 mb-6 sm:mr-6 sm:mb-0">
                    <div className="w-64 h-64 rounded-full overflow-hidden">
                        <div className="">
                            <picture>
                                <StaticImage src="../../../../images/rizki.png" alt="profil"></StaticImage>
                            </picture>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col justify-center items-center sm:items-center max-w-screen-xl">
                    ...
                    <div className="mb-3 ml-[3px] font-light">
                        <span className="ml-2 text-center sm:text-left mb-0">Open Source Project feature on GitHub</span>
                    </div>
                    <div className="mb-3 ml-[4px] font-light text-gray-500 flex flex-row items-center">
                    ...
                    <div className="mr-[169px]">
                        <ul className="flex flex-row flex-wrap justify-start">
                            <li className="flex flex-row items-center  mr-4 mb-2">
                                <Link to={"https://www.lonkedin.com/"} className="transition duration-200 ease-in-out flex flex-row items-center text-black hover:text-red-600" title="Muhammad Rizki Linkedin" target="_blank">
                            ...
                            <li className="flex flex-row items-center  mr-4 mb-2">
                                <Link to={"https://www.github.com/MRizki28/"} className="transition duration-200 ease-in-out flex flex-row items-center text-black hover:text-red-600" title="Muhammad Rizki github" target="_blank">
            ...
            <div>
                <p className="font-light max-w-screen-xl">Hey there! I'm Muhammad Rizki. I work as a full-time software engineer. In my free time I do open source. Most of my open source
                    project
                    focuses on one thing – to help people learn. You can see it in my repo if you want to test and use it for your project</p>
            </div>
        </>
    )
}
