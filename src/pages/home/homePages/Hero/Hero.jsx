                ...
                <div className="mr-[145px]">
                    <ul className="flex flex-row flex-wrap justify-start">
                        <li className="flex flex-row items-center  mr-4 mb-2">
                            <Link to={"https://www.lonkedin.com/"} className="transition duration-200 ease-in-out flex flex-row items-center hover:text-red-600" title="Muhammad Rizki Linkedin" target="_blank">
                        ...
                        <li className="flex flex-row items-center  mr-4 mb-2">
                            <Link to={"https://www.github.com/MRizki28/"} className="transition duration-200 ease-in-out flex flex-row items-center hover:text-red-600" title="Muhammad Rizki github" target="_blank">
